...
(defun step (tape i)
  (let ((op (aref tape i)))
    (cond
      ((integerp op)
       (cond
	 ((= op 1) (step (exec-add tape i) (+ i 4))) ;; ADD 4 step
	 ((= op 2) (step (exec-mul tape i) (+ i 4))) ;; MUL 4 step
	 ((= op 3) (step (exec-read tape i) (+ i 2))) ;; READ 2 step
	 ((= op 4) (step (exec-write tape i) (+ i 2))) ;; WRITE 2 step
	 ((= op 99) tape)
