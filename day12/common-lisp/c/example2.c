...
int main(){
  px1 = -8LL ; py1 = -10LL ; pz1 = 0LL ;
  px2 = 5LL ; py2 = 5LL ; pz2 = 10LL ;
  px3 = 2LL ; py3 = -7LL ; pz3 = 3LL ;
  px4 = 9LL ; py4 = -8LL ; pz4 = -3LL ;
  while (1) {
    // moons 1 - 2 
    // x 
    // x axis 
    ...
    if (count % 1000000 == 0){
      printf("count so far %" PRId64 "\n ", count);
    }
    if (px1 != -8LL) { continue; }
    if (py1 != -10LL) { continue; }
    if (pz1 != 0LL) { continue; }
    if (px2 != 5LL) { continue; }
    if (py2 != 5LL) { continue; }
    if (pz2 != 10LL) { continue; }
    if (px3 != 2LL) { continue; }
    if (py3 != -7LL) { continue; }
    if (pz3 != 3LL) { continue; }
    if (px4 != 9LL) { continue; }
