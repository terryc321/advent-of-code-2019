...
int main(){
  px1 = 4LL ; py1 = 1LL ; pz1 = 1LL ;
  px2 = 11LL ; py2 = -18LL ; pz2 = -1LL ;
  px3 = -2LL ; py3 = -10LL ; pz3 = -4LL ;
  px4 = -7LL ; py4 = -2LL ; pz4 = 14LL ;
  while (1) {
    // moons 1 - 2 
    // x 
    // x axis 
    ...
    if (py1 != 1LL) { continue; }
    if (pz1 != 1LL) { continue; }
    if (px2 != 11LL) { continue; }
    if (py2 != -18LL) { continue; }
    if (pz2 != -1LL) { continue; }
    if (px3 != -2LL) { continue; }
    if (py3 != -10LL) { continue; }
    if (pz3 != -4LL) { continue; }
    if (px4 != -7LL) { continue; }
    if (py4 != -2LL) { continue; }
    if (pz4 != 14LL) { continue; }
    break;
